...
URL = "https://github.com/OpenVoiceOS/skill-ovos-wallpapers"
SKILL_CLAZZ = "WallpapersSkill"  # needs to match __init__.py class name
PYPI_NAME = "ovos-skill-wallpapers"  # pip install PYPI_NAME
